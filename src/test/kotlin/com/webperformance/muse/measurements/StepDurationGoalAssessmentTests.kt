...
class StepDurationGoalAssessmentTests
{
	...
	fun failGoal()
	{
		...
		end_event.timestampNanos = start_event.timestampNanos + 2000 * 1000000 // 2 seconds in nanos
...
//		GoalAssessmentEvent
	...
	fun passGoal()
	{
		...
		val start_event = StepEvent(StepEvent.START_TYPE, step_config, context)
		val end_event = MockStepEvent(StepEvent.END_TYPE, step_config, context)
		end_event.timestampNanos = start_event.timestampNanos + 900 * 1000000 // 900 ms in nanos
