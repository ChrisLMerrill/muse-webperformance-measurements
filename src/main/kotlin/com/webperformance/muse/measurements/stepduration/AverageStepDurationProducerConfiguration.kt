 ...
 */
@MuseTypeId("average-step-duration-producer")
...
class AverageStepDurationProducerConfiguration : GenericResourceConfiguration(), PluginConfiguration
{
	...
	class StepDurationProducerType : ResourceSubtype(TYPE_ID, "Average Step Duration Measurement Producer", AverageStepDurationProducerConfiguration::class.java, PluginConfiguration.PluginConfigurationResourceType())
	{
		...
		{
			val config = AverageStepDurationProducerConfiguration()
	...
	companion object
	{
		...
		val TYPE_ID = AverageStepDurationProducerConfiguration::class.java.getAnnotation(MuseTypeId::class.java).value
